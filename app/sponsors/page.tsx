...
const formats: Format[] = [
  {
    ...
    description:
      "Раз на два тижні по середах Олександра Хілова й Олеся Коробка розбирають те, що зараз реально болить в SEO. Ефір живе на чотирьох майданчиках, і до переглядів на YouTube додається анонс у телеграмі на 1 800–2 700 людей.",
    includes: [
...
const audience = [
  ...
  "Email-розсилка: щотижневий лист, спонсор названий і в ньому",
