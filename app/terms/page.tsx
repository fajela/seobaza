      ...
      <article className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-foreground/90 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Наш контент відкритий. Матеріали SEO BAZA можна вільно читати,
              копіювати, перекладати, переробляти й поширювати, зокрема в
              комерційних цілях, без окремого дозволу. Посилання на джерело
              вітається, але не обовʼязкове.
            </p>
            <p className="mt-3">
              Єдина заборона: видавати себе за SEO BAZA. Не можна використовувати
              назву, бренд чи логотип SEO BAZA так, що це створює враження, ніби
              ваш матеріал, сайт чи проєкт є офіційним SEO BAZA або випущений
              від нашого імені.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-display mb-3">Бренд і чужі матеріали</h2>
            <p>
              Самі тексти й матеріали відкриті для використання (див. вище).
              Назва й логотип SEO BAZA лишаються нашими лише як знак походження,
              щоб ніхто не видавав себе за нас. Логотипи, цитати й матеріали
              третіх сторін належать їхнім власникам і використовуються для
              ілюстрації та огляду.
            </p>
          </section>
