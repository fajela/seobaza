...
const tiers = [
  { name: "Один випуск", amount: "від $250", per: "", note: "Разове розміщення в одному ефірі", pick: false },
  { name: "10 випусків", amount: "$2 000", per: "", note: "Ціна за випуск зафіксована наперед. Плюс банер у розсилці на весь період і пріоритет у виборі дат і тем", pick: true },
];
