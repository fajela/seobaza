...
const formats: Format[] = [
  {
    ...
    price: "$350",
    priceNote: "за випуск · 4 випуски $1 200 · 10 випусків $2 500",
    description:
  ...
  {
    id: "giveaway",
    title: "Розіграш в ефірі",
    price: "$200",
    priceNote: "доповнення до відео або дайджесту",
    description:
      "Ваш приз розігрують просто в ефірі. Це не покази, а дії: люди пишуть у чат, коментують і переходять за посиланням.",
    includes: [
      "Оголошення призу й умов в ефірі",
      "Посилання на вас у чаті трансляції",
      "Підсумки розіграшу окремим постом у телеграмі",
    ],
  },
  {
    id: "jobs",
  ...
  {
    id: "general",
    title: "Генеральний партнер року",
    price: "$9 000",
    priceNote: "за рік · один партнер",
    description:
      "Усе одразу й без перерв, з пріоритетом у виборі тем і дат. Окремо ці самі позиції коштують $12 500.",
    includes: [
      "10 відеосеред і 12 дайджестів",
      "Партнер місяця цілий рік і банер у розсилці без перерв",
      "Спільні активності зі спільнотою",
    ],
  },
];
        ...
        >
          <span>
            ...
            <span className="block text-sm text-muted-foreground">
              Усі формати, цифри й приклади розміщень на 8 сторінках
            </span>
          </span>
